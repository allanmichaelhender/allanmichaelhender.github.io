...
export const projects: Project[] = [
  ...
  },
  {
    ...
    briefDescription: "AI-Powered Garmin Activity Analysis",
    fullDescription:
      "An AI-powered Garmin activity analysis platform. Syncs workouts from Garmin Connect, analyses heart rate profiles with Anthropic Claude, and exposes tools via a FastMCP server for AI agents (ZeroClaw) to query and explore training data. Features batch HR analysis with changepoint detection and automated interval classification.",
    images: [],
    videos: ["/hybrid-footage-trimmed.mp4"],
    videoZoom: 100,
    videoDim: 75,
